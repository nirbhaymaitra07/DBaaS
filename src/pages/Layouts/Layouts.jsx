        ...
        <div className="layouts-container">
          <div className="top-section">
            ...
            <div className="image-container">
              <img
                src={Add}
                alt="AddButton"
                onClick={() => navigate("/layouts/newlayout")}
              />
            </div>
          </div>
          <div className="bottom-section">
            <div className="tabs">
              <div
                className="custom"
                id={`${activeTab === "custom" ? "activetab" : ""}`}
                onClick={() => switchActiveTab("custom")}
              >
                <span>Custom</span>
              </div>
              <div
                className="templates"
                id={`${activeTab === "templates" ? "activetab" : ""}`}
                onClick={() => switchActiveTab("templates")}
              >
                <span>Templates</span>
              </div>
            </div>
            {activeTab === "custom" ? (
              <div className="custom-card-container">
                {DataConfiguration.map((item) => (
                  <CustomLayoutcard key={item.Area} item={item} />
                ))}
              </div>
            ) : (
